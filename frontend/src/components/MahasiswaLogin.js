// frontend/src/components/MahasiswaLogin.js
...
const MahasiswaLogin = () => {
  ...
  const Auth = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/login-mahasiswa", {
        nim,
        password,
      });
          ...
          <div className="columns is-centered mt-5">
            <div className="column is-4-desktop">
              ...
              <form onSubmit={Auth} className="box">
                ...
                <h2 className="title is-4 has-text-centered">LOGIN MAHASISWA</h2>
                <div className="field mt-5">
                  <div className="control has-icons-left">
                    <input
                      type="text"
                      className="input is-rounded"
                      placeholder="Masukin NIM lu"
                      value={nim}
                ...
                <div className="field mt-3 has-text-centered">
                  <a href="/login-admin" className="has-text-white">Masuk sebagai Admin</a>
                </div>
              </form>
            </div>
          </div>
